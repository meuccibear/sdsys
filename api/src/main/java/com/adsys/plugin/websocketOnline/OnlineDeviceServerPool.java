...
public class OnlineDeviceServerPool {
    protected static Logger logger = Logger.getLogger(OnlineDeviceServerPool.class);


    private static final Map<WebSocket, String> userconnections = new HashMap<WebSocket, String>();

    private static WebSocket wbconn = null;
    ...
    public static void setFhadmin(WebSocket wbconn) {
        OnlineDeviceServerPool.wbconn = wbconn;
    }
}
