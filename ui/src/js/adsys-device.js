...
function devDetailFormatter(index, row) {
    ...
    var html = '<div class="col-md-12"><div class="col-md-10" style="border-right: 1px solid #e6e6e6;"><div class="col-md-12"><div class="col-md-2"><img src="' + picpath + '" class="img-polaroid"  width="100%" height="auto"></img></div><div class="col-md-10"><div class="bio-row"><p><span>网络地址 </span>： ' + row.ext.ipaddr + '</p></div><div class="bio-row"><p><span>设备分组 </span>： ' + checkGroupPath(row.group) + '</p></div><div class="bio-row"><p><span>正在播放 </span>： ' + row.ext.playing + '</p></div></div></div></div><div class="col-md-2"><div class="col-md-12 bio-full"><button type="button" class="btn btn-warning btn-sm  center-block" onclick="editDeviceModalPage(\'' + row.did + '\');">编辑</button></div><div class="col-md-12 bio-full"><button type="button" class="btn btn-danger  center-block btn-sm" onclick="delDev(\'' + row.did + '\');">删除</button></div></div></div>';
    return html;
}
