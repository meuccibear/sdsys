...
(function( $ ){
    ...
    $(function() {
        ...
        uploader = WebUploader.create({
            ...
            server: getRootUrl()+'files/save',
            //runtimeOrder: 'flash',

            accept: {
                 title: 'Images',
                 extensions: 'gif,jpg,jpeg,bmp,png,pdf,doc,docx,txt,xls,xlsx,ppt,pptx,zip,rar,mp4,rmvb,mp3,mp2,wav,wmv,ts,mov,avi,flv',
                 mimeTypes: '*/*'
             },
